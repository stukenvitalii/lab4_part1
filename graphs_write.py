...
# Перебор файлов
for i in range(5):
    filename = f"D:/tanki/University/OS/lab4/cmake-build-debug/logs/writelogs/writeLog #{i}.txt"
    states = []
    times = []
    ...
    if os.path.exists(filename):
        ...
        plot_filename = f"D:/tanki/University/OS/lab4/graphs/graph_write_{i}.png"
